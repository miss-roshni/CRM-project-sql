...
begin
	 ...
	 insert into crm.daily_top_products(report_date,product_id,total_sales,rank)
	 select 
	 ...
	 from crm.orders as o
	 inner join crm.order_items as oi on o.order_id=oi.order_id
	 inner join crm.products as p on oi.product_id=p.product_id
...
insert into crm.orders(order_id,customer_id,order_date)
values(101,1,current_date),(102,2,current_date),(103,3,current_date)


insert into crm.customer
values(2,'Archi','tyagi','archi@gmail.com',987564268,'up',101,current_date),
(3,'Avni','Kumari','avni@gmail.com',987854260,'Delhi',101,current_date)
...
values
(8,102,2,5,100000)
call insert_daily_top_products()